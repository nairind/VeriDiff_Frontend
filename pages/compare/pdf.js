              ...
              <div style={sectionStyle}>
                ...
                <div style={{ textAlign: 'center', marginTop: '2rem' }}>
                  ...
                  <button 
                    ...
                    style={{
                      background: (() => {
                        if (loading) return 'linear-gradient(135deg, #94a3b8, #64748b)';
                        if (pdfLoadingStatus !== 'loaded') return 'linear-gradient(135deg, #6366f1, #4f46e5)';
                        if (!file1 || !file2) return 'linear-gradient(135deg, #94a3b8, #64748b)';
                        return 'linear-gradient(135deg, #dc2626, #ea580c)';
                      })(),
                      color: 'white',
                      border: 'none',
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        <span>Select PDF Files to Compare</span>
                      </>
                    ) : (
                      <>
                        <span style={{ fontSize: '1.2rem' }}>🚀</span>
